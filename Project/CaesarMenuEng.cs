...
{
    /// <summary>
    /// Класс создает меню шифра Цезаря на английском языке
    /// </summary>
    public static class CaesarMenuEng
    {
        /// <summary>
        ...
        /// <summary>
        /// Метод для отображения пунктов меню при зашифровании сообщения
        /// </summary>
...
░                                                     ");
            ...
            else
            {
                ...
                Console.ForegroundColor = ConsoleColor.DarkYellow;
                caesarCipher.EncrypEng(input, key);
...
░                                                     ");
            ...
            else
            {
                ...
                Console.ForegroundColor = ConsoleColor.DarkYellow;
                caesarCipher.DecrypEng(input, key);
